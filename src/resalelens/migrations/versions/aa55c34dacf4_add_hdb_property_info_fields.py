...
def upgrade() -> None:
    ...
    # Facility flags
    op.add_column('blocks', sa.Column('residential', sa.Boolean(), nullable=True, server_default='true'))
    op.add_column('blocks', sa.Column('commercial', sa.Boolean(), nullable=True, server_default='false'))
    op.add_column('blocks', sa.Column('market_hawker', sa.Boolean(), nullable=True, server_default='false'))
    op.add_column('blocks', sa.Column('multistorey_carpark', sa.Boolean(), nullable=True, server_default='false'))
    op.add_column('blocks', sa.Column('precinct_pavilion', sa.Boolean(), nullable=True, server_default='false'))
    op.add_column('blocks', sa.Column('miscellaneous', sa.Boolean(), nullable=True, server_default='false'))
